  ...
  <form class="flex text-white bg-gray-800 overflow-hidden">
    <div class="relative">
      <select
        name="sort"
        v-model="selectSort"
        class="cursor-pointer overflow-hidden z-10 font-normal pr-9 text-sm appearance-none border-none bg-gray-800 focus:outline-hidden focus:ring-0 px-2 py-2 m-0"
        id="sort-select"
      >
